...
// Enemy inherites and specifies out Enemies our player must avoid
...
class playerClass extends gameEntity{
    ...
    handleInput(key){
       if(this.y<0) //exit function if you won.
        return;
    ...
    winner(){
        window.ctx.font = "72px Arial";
        window.ctx.fillText("You Win!",100,250);
        window.ctx.font = "36px Arial";
        window.ctx.fillText("Press ctrl+r to restart",100,350);
    }
}//end of playerClass
